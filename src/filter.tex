...
\section{Orientación}
    ...
    \subsection{Cuaternion}
        ...
        \begin{figure}[htp!]
            \centering
            \includegraphics[width = 0.40 \textwidth]{quaternion_representation.png}
        ...
        En el cuadro \ref{table: Cayley} se nos describe como es la operación de las componentes entre si para un cuaternion.
    ...
    \begin{figure}[htp!]
        \centering
             \includegraphics[width = 0.40 \textwidth]{tait-bryan_axis_representation.png}
